...
var Backbone, BasePlugin, CSON, Collection, DocPad, DocumentModel, ElementsCollection, EventEmitterEnhanced, Events, FileModel, FilesCollection, MetaCollection, Model, PluginLoader, QueryCollection, ScriptsCollection, StylesCollection, View, balUtil, canihaz, caterpillar, pathUtil, queryEngine, util, _, _ref,
...
DocPad = (function(_super) {
  ...
  */
  ...
  DocPad.prototype.ready = function(opts, next) {
    ...
    tasks.push(function() {
      ...
      if (_this.userConfig.identified !== true) {
        mixpanelInstance.people.set(_this.userConfig.username, balUtil.extend(userData, {
          $created: lastLogin,
  ...
  DocPad.prototype.setInstanceConfig = function(instanceConfig) {
    if (instanceConfig) {
      balUtil.safeDeepExtendPlainObjects(this.instanceConfig, instanceConfig);
      if (this.config) {
        balUtil.safeDeepExtendPlainObjects(this.config, instanceConfig);
      }
    }
    return this;
  };
  ...
  DocPad.prototype.generateCheck = function(opts, next) {
    ...
    balUtil.exists(config.srcPath, function(exists) {
      var err;
  ...
  DocPad.prototype.skeleton = function(opts, next) {
    ...
    useNoSkeleton = function() {
      ...
      return balUtil.ensurePath(srcPath, function(err) {
        ...
        return balUtil.ensurePath(config.filesPaths[0], tasks.completer());
      });
    };
