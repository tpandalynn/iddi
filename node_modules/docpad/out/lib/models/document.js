...
var CSON, DocumentModel, FileModel, YAML, balUtil, mime, pathUtil, _ref,
...
DocumentModel = (function(_super) {
  ...
  DocumentModel.prototype.renderExtensions = function(opts, next) {
    var content, context, extension, extensions, extensionsReversed, file, filename, index, renderSingleExtensions, result, tasks, templateData, _i, _j, _len, _len1, _ref1;
    ...
    _ref1 = extensionsReversed.slice(1);
    for (index = _j = 0, _len1 = _ref1.length; _j < _len1; index = ++_j) {
      extension = _ref1[index];
      context = {
